...
<head>
    ...
    <title>FPP HA Discovery</title>
</head>
<body>
    <h1>Welcome</h1>
    This plugin helps Home Assistant automatically discover your FPP instance via MQTT auto discovery.<br>
    <br>
    ...
    If you already had MQTT configured, there is nothing more to do. The plugin will send the auto discovery payload on startup.
